...
function displayCurrentWeather(cityName){
    ...
    .then((data) => {
        ...
        // O sa luam ziua din saptamana - pentru asta ne folosim de dt - ca sa facem asta o sa ne cream un util de date 
        ...
        descriptionElement.innerHTML = `
            <div class="px-3">
                ...
                <div class="d-flex align-itemes-center justify-content-center">
